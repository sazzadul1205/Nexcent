    ...
    return (
        <div className="bg-white my-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:mx-36 justify-center items-center">
                {CU.map((card, index) => (
                    <div key={index} className="card lg:w-96 shadow-xl my-4 text-[#4D4D4D] mx-auto mb-32">
                        <figure className="">
                            <div className="justify-center items-center ">
                                ...
                                <img src={card.imgSrc} alt={`Image ${index + 1}`} className="rounded-xl w-full relative" />
                            </div>
                        </figure>
                    </div>
                ))}
